...
async function checkForUpdates() {
    try {
        ...
        let latestVersion;
        const VERSION_URL = {
            PROXY: 'https://raw.ihtw.moe/raw.githubusercontent.com/LibreSpark/EpicTV/main/VERSION.txt',
            DIRECT: 'https://raw.githubusercontent.com/LibreSpark/EpicTV/main/VERSION.txt'
        };
            ...
            setTimeout(() => {
                ...
                if (updateBtn) {
                    updateBtn.addEventListener('click', () => {
                        window.open('https://github.com/LibreSpark/EpicTV', '_blank');
                    });
                }
            }, 100);
        } else {
